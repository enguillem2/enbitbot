...
dex = fetch_deployment(
    web3,
    factory_address="0xd03D8D566183F0086d8D09A84E1e30b58Dd5619d",
    router_address="0x5aEaF2883FBf30f3D62471154eDa3C0c1b05942d",
    init_code_hash="0x1cb011040b91cd937ddff2327f17c9690653b05b6506e830baadf2493468d657",
)

print(f"Uniwap v2 compatible router set to {dex.router.address}")

# Read and setup a local private key
private_key = pk_mainnet_ox
